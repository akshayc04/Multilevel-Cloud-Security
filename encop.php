...
<body>
	...
	<h1 style="color:#fff;letter-spacing:3px;">CHOOSE THE TYPE OF FILE TO BE ENCRYPTED AND LOCKED</h1></div><br><br><br>
	 <div class="col-md-2"></div>
	<div class="col-md-8">
	<div align="center">
	<a href="encrypt1.php" style="margin:20px;"class="btn btn-primary inverse btn-lg scrollpoint sp-effect1">Plain Text</a>
	<a href="encrypt.php" style="margin:20px;"class="btn btn-primary inverse btn-lg scrollpoint sp-effect2">Text With Images</a>
	</div>
	</div>
