...
<form method = "POST" id="uploading_file0">
	<div align="center" class="container-fluid"style="padding:40px;padding-bottom:60px;">
		<h2 style="color:#fff;letter-spacing:3px;" class="scrollpoint sp-effect3">RE-ASSEMBLE</h2><br>
		<h5 style=" color:white;font-family:'Generica';letter-spacing:3px;" class="scrollpoint sp-effect3">Choose The File To Be Re-Assembled</h5>
		...
		<input type="submit" class="text btn btn-primary inverse btn-lg scrollpoint sp-effect1" value="Re-Assemble" />
	</div>
</form>
